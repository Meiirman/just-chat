...
SECRET_KEY = 'django-insecure-e1jr#85h@mo#xtmt501j9rr(jv6c-5%mdg^c=k$#i*u&unr405'
...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels.layers.InMemoryChannelLayer',  # Используйте channels.layers.RedisChannelLayer для работы с Redis
    },
}
